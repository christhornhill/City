...
#
#  $ bin/test -s aptean.city -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src aptean.city.testing.APTEAN_CITY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/aptean/city/tests/robot/test_example.robot
#
